    ...
    <PageContainer>
      <div className="mx-auto max-w-4xl space-y-10">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Card>
                ...
                <CardContent className="text-muted-foreground space-y-1 text-xs">
                  ...
                  <p>
                    Saves these as{' '}
                    <code className="bg-muted rounded px-1 font-mono">normContext</code> — the
                    bridge between training and scoring.
                  </p>
                </CardContent>
              </Card>
              <Card>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-sm leading-relaxed">
            <p>
              Wire fraud is rare — typically 0.1-1% of transactions. In this class-imbalanced
              setting:
            </p>
            <ul className="text-muted-foreground ml-4 list-disc space-y-1 text-xs">
              <li>
                <strong>Accuracy is misleading</strong> — a model that predicts &quot;normal&quot;
                for every wire achieves 99%+ accuracy but catches zero fraud.
              </li>
              <li>
                <strong>ROC-AUC is inflated</strong> — the massive number of true negatives makes
                even poor models look good on ROC curves.
              </li>
              <li>
            ...
            <p className="text-muted-foreground text-xs">
              ...
              the two heaviest factors — together they represent 65% of the champion selection
              score.
            </p>
          </div>
        </section>
        ...
        <div className="border-border text-muted-foreground border-t pt-6 text-center text-xs">
          <p>
            All ML algorithms are implemented in pure TypeScript. No external Python dependencies,
            no API calls to third-party services. Training and inference run entirely within the
